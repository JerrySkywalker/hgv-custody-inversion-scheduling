...
%PLOT_OUTERA_VS_PHI_ALIGNMENT  Plot bad phi segments against outerA trigger states.
...
ylabel('\phi')
title('Phase 6B OuterA vs Bad Phi Segments')
grid on

subplot(2,1,2)
stairs(t, state, 'LineWidth', 1.2); hold on
for i = 1:numel(alignment.trigger_starts)
    xline(t(alignment.trigger_starts(i)));
end
yticks([0 1 2])
