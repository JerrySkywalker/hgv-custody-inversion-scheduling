function [value, isterminal, direction] = events_hgv_stage02(~, X, cfg, p)
    %EVENTS_HGV_STAGE02 Unified event function for Stage02.
        ...
        h_m = r - p.Re;
        [x_km, y_km] = geodetic_to_local_xy_stage02(phi, lambda, cfg);
