function satbank = legacy_propagate_constellation_stage03_impl(walker, t_s)
%LEGACY_PROPAGATE_CONSTELLATION_STAGE03_IMPL Copied Stage03 constellation propagator.
