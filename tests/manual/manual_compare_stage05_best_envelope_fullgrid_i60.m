function out = manual_compare_stage05_best_envelope_fullgrid_i60()
startup;
...
rows = manual_make_stage05_fullgrid_i60();
...
disp('[manual] Stage05 full-grid i=60 best-pass envelope comparison completed.');
disp(compare_tbl);
end
