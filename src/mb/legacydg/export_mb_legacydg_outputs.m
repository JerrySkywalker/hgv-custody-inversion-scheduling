...
for idx = 1:numel(run_output.runs)
    ...
    pass_global_csv = fullfile(paths.tables, sprintf('MB_legacyDG_passratio_globalFullReplay_%s_%s.csv', h_label, sensor_group));
    ...
    global_view_spec.figure_name = sprintf('MB_legacyDG_passratio_globalFullReplay_%s_%s.png', h_label, sensor_group);
    ...
    local_retitle(fig_pass_global, sprintf('legacyDG Global Full Replay Pass-Ratio versus N_s at h = %.0f km [%s]', run.h_km, sensor_label));
    pass_global_png = fullfile(paths.figures, sprintf('MB_legacyDG_passratio_globalFullReplay_%s_%s.png', h_label, sensor_group));
    ...
    legacy_zoom_options.current_mode = "frontierZoom";
    legacy_zoom_options.plot_view_contract = resolve_mb_plot_view_contract(local_getfield_or(plot_options, 'runtime', struct()), struct('passratio_mode', "frontierZoom"));
    fig_pass_zoom = plot_mb_passratio_by_contract(pass_zoom_table, run.h_km, style, legacy_zoom_options, legacy_zoom_options.plot_view_contract);
