function result = run_MB_nominal_small_formal_master()
startup;

out = run_MB_nominal_small_formal();
...
artifact_truth = artifact_service(truth_table, output_dir, 'mb_nominal_small_formal_truth_table');
artifact_min = artifact_service(minimum_result.solution_table, output_dir, 'mb_nominal_small_formal_minimum_solution');
artifact_near = artifact_service(minimum_result.near_optimal_table, output_dir, 'mb_nominal_small_formal_near_optimal_solution');

manifest = make_artifact_manifest( ...
    'mb_nominal_small_formal_master_run', ...
...
disp('[experiment] MB nominal small-formal master run completed.');
