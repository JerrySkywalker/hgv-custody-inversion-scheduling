function spec = make_stage05_closedd_manual_raan_fullgrid_spec(varargin)
%MAKE_STAGE05_CLOSEDD_MANUAL_RAAN_FULLGRID_SPEC Build Stage05 ClosedD manual-RAAN full-grid spec.
...
req5.name = 'hm_min_joint_margin';
req5.metric_name = 'joint_margin';
req5.fixed_filters = struct();
req5.row_key = 'P';
req5.col_key = 'T';
req5.scenario_metric = 'joint_margin';
