function out = manual_smoke_stage05_opend_legacy_reproduction_compare()
startup;

artifact_root = fullfile('outputs','experiments','chapter4','stage05_legacy_reproduction','compare_smoke');
