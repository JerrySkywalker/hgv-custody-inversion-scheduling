...
%STAGE11_DIAGNOSIS_SUMMARY Build compact Stage11 coverage diagnosis summaries.
    ...
    reason_order = ["ok", "no_reference_match", "partial_reference_match", ...
        "weak_invalid", "sub_invalid", "all_bounds_invalid", "numerical_issue"];
    ...
    summary_table = table(total_windows, valid_windows, valid_ratio, total_cases, ...
        ...
        safe_cases, warn_cases, reject_cases, ...
