    ...
    switch char(string(src.source_id))
        case 'src_nominal_ring'
            ...
            nominal_items = generate_disk_ring_nominal( ...
                ...
                'anchor_lat_deg', spec.anchor_lat_deg, ...
                'anchor_lon_deg', spec.anchor_lon_deg, ...
                'anchor_h_m', spec.anchor_h_m);
        ...
        case 'src_critical_tracks'
            ...
            track_specs = make_critical_track_specs( ...
            ...
            critical_items = generate_single_track_set(track_specs);
