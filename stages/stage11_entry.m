...
%STAGE11_ENTRY Stage11 orchestrator for tightened geometric certificates.
    ...
    if cfg.stage11.enable_weak
        ...
        out.window_table.n_groups_fallback = weak_table.n_groups_fallback;
        out.window_table.match_ratio = weak_table.match_ratio;
        out.window_table.reference_match_ratio = weak_table.reference_match_ratio;
        out.window_table.supported_ratio = weak_table.supported_ratio;
        out.window_table.fully_supported = weak_table.fully_supported;
        ...
        out.window_table.fallback_group_keys = weak_table.fallback_group_keys;
        out.window_table.group_status_list = weak_table.group_status_list;
        out.window_table.template_residual_min_list = weak_table.template_residual_min_list;
