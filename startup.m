...
%STARTUP Initialize project paths, outputs folders, and graphics defaults.
    ...
    path_specs = { ...
        ...
        struct('label', 'paper',                'path', fullfile(root_dir, 'paper'),                'recursive', true,  'required', false), ...
        ...
        struct('label', 'deliverables',         'path', fullfile(root_dir, 'deliverables'),         'recursive', true,  'required', false)  ...
    };
    ...
    fprintf('[startup] ensure outputs        : %.3f s\n', toc(t_outputs));
    ...
    fprintf('[startup] graphics defaults    : %.3f s\n', toc(t_graphics));

    fprintf('[startup] total startup        : %.3f s\n', toc(t_total));
