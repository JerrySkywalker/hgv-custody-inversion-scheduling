...
for idx_ctx = 1:size(contexts, 1)
    ...
    if ~isempty(pass_table)
        ...
        history_view_spec = struct( ...
            ...
            'figure_name', sprintf('MB_profileCompare_%s_passratio_historyFull_%s.png', char(semantic_mode), context_tag));
        ...
        milestone_common_save_table(pass_table, pass_effective_csv);
        milestone_common_save_table(pass_table, pass_zoom_csv);
        ...
        write_mb_plot_domain_sidecar(pass_effective_png, "effective_full_range", "effective_search_domain", local_capture_axis_xlim(fig_pass_effective), ...
            build_mb_passratio_view_sidecar_fields(fig_pass_effective, pass_table, pass_effective_csv, "effective_full_range", pass_windows.effective_full_range, struct(), struct( ...
            'figure_family', string(semantic_mode) + "_cross_profile_passratio", ...
        ...
        write_mb_plot_domain_sidecar(pass_alias_png, "effective_full_range", "effective_search_domain", local_capture_axis_xlim(fig_pass_effective), ...
            build_mb_passratio_view_sidecar_fields(fig_pass_effective, pass_table, pass_effective_csv, "effective_full_range", pass_windows.effective_full_range, struct(), struct('figure_family', string(semantic_mode) + "_cross_profile_passratio")));
        ...
        write_mb_plot_domain_sidecar(pass_zoom_png, "frontier_zoom", "frontier_zoom_window", local_capture_axis_xlim(fig_pass_zoom), ...
            build_mb_passratio_view_sidecar_fields(fig_pass_zoom, pass_table, pass_zoom_csv, "frontier_zoom", pass_windows.frontier_zoom, struct(), struct( ...
            'figure_family', string(semantic_mode) + "_cross_profile_passratio", ...
