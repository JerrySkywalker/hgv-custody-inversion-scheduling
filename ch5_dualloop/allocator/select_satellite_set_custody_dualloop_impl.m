function selected_ids = select_satellite_set_custody_dualloop_impl(caseData, k, prev_ids, mode, cfg)
%SELECT_SATELLITE_SET_CUSTODY_DUALLOOP_IMPL
% P-Back-1
% Canonical implementation shared by both allocator/ and outer_loop_B/ entrypoints.
%
% Current behavior:
%   - baseline path preserved when prior/filter disabled
%   - template-guided reference selection
%   - template-guided top-K candidate filtering
%
% This file is the only place where the real logic should live.
