function test_static_heading_master_run_bootstrap()
startup;

result = run_MB_heading();
...
assert(strcmp(result.out.task_family.name, 'heading'), 'Expected heading task family.');
...
disp('test_static_heading_master_run_bootstrap passed.');
end
