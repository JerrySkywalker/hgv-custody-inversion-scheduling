...
for idx = 1:numel(comparison.run_pairs)
    ...
    pass_global_csv = fullfile(paths.tables, sprintf('MB_comparison_passratio_overlay_globalFullDense_%s_%s.csv', h_label, sensor_group));
    ...
    global_view_spec.figure_name = sprintf('MB_comparison_passratio_overlay_globalFullDense_%s_%s.png', h_label, sensor_group);
    ...
    fig_pass_global = plot_semantic_gap_passratio_curves(pass_global_table, pair.h_km, sensor_label, struct( ...
        ...
        'runtime', local_getfield_or(plot_options, 'runtime', struct()), ...
        'figure_style', local_getfield_or(plot_options, 'figure_style', struct())));
    pass_global_png = fullfile(paths.figures, sprintf('MB_comparison_passratio_overlay_globalFullDense_%s_%s.png', h_label, sensor_group));
    ...
    write_mb_plot_domain_sidecar(pass_global_png, "global_full_dense", "full_search_domain", local_capture_axis_xlim(fig_pass_global), ...
        ...
        'is_primary_selection', plot_mode_profile.comparison_primary_mode == "globalFullDense", ...
    ...
    summary_context = local_summary_context_table(pair, struct( ...
        ...
        'global_full_dense_rendered_min_ns', local_pick_x(local_capture_axis_xlim(fig_pass_global), 1), ...
    ...
    artifacts.tables.(matlab.lang.makeValidName(sprintf('passratio_overlay_globalFullDense_%s', h_label))) = string(pass_global_csv);
