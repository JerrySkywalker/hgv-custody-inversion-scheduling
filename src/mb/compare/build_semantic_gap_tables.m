...
comparison.run_pairs = repmat(struct( ...
    ...
    'legacy_eval_table', table(), ...
    'closed_eval_table', table(), ...
    'legacy_passratio_table', table(), ...
    'closed_passratio_table', table(), ...
...
for idx = 1:numel(legacy_output.runs)
    ...
    comparison.run_pairs(pair_cursor, 1) = struct( ...
        ...
        'legacy_eval_table', legacy_run.eval_table, ...
        'closed_eval_table', closed_run.eval_table, ...
        'legacy_passratio_table', legacy_run.aggregate.passratio_phasecurve, ...
        'closed_passratio_table', closed_run.aggregate.passratio_phasecurve, ...
