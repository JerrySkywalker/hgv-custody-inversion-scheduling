function selection = select_satellite_set_static(policy, k)
%SELECT_SATELLITE_SET_STATIC  Return static selection at time index k.
...
selection.name = 'static_hold_selection';
