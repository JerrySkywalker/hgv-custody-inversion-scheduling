...
window_table = table( ...
    ...
    window_grid.t0_s(:), DG_window, DA_window, DT_window, ...
    false(nW, 1), false(nW, 1), false(nW, 1), ...
    'VariableNames', {'case_id', 't0_s', 'DG_window', 'DA_window', 'DT_window', ...
    'DG_is_worst', 'DA_is_worst', 'DT_is_worst'});
...
summary_table = table( ...
    ...
    DG_window(idxG), DA_window(idxA), DT_window(idxT), ...
    window_grid.t0_s(idxG), window_grid.t0_s(idxA), window_grid.t0_s(idxT), ...
    'VariableNames', {'case_id', 'case_family', ...
    'DG_worst_truth', 'DA_worst_truth', 'DT_worst_truth', ...
    't0G_star_s', 't0A_star_s', 't0T_star_s'});
