function test_diagnose_nominal_stage05_threshold_bootstrap()
startup;

result = run_diagnose_nominal_stage05_threshold();
...
assert(all(ismember({'design_id','new_gamma_eff_scalar','new_DG_rob','legacy_gamma_req', ...
    'legacy_DG_min','new_pass_ratio','legacy_pass_ratio','feasible_match'}, ...
...
disp('test_diagnose_nominal_stage05_threshold_bootstrap passed.');
end
