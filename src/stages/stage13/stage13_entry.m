...
fixed_rows = table( ...
    ["dt_first_probe_P6T4F0"; "dg_micro_07"; "dg_first_probe_3"], ...
    ["dt_first_probe"; "dg_refined_micro"; "dg_first_probe"], ...
    ["recommended_for_MA"; "backup_for_MB_or_defense"; "development_only"], ...
    ["MA extension baseline-neighborhood control"; ...
    "DG-refined backup only; not for MA export"; ...
    "Legacy DG probe reference kept for development trace"], ...
    'VariableNames', {'case_tag', 'family', 'tier', 'export_role'});
tier_table = unique([tier_table; fixed_rows], 'rows', 'stable');
