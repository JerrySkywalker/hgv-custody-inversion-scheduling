...
summary_table = table( ...
    ...
    Tw_s, result.DG_rob, result.DA_rob, result.DT_rob, logical(result.feasible_flag), string(result.dominant_fail_tag), ...
    ...
    'baseline_Tw_s', 'DG_worst_truth', 'DA_worst_truth', 'DT_worst_truth', 'is_feasible_truth', 'dominant_metric'});
