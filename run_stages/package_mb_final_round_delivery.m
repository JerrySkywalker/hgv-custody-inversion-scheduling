...
items = { ...
    ...
    fullfile(fileparts(baseline_root), 'STAGE_plot_runtime_smoke_' + tag + "_stage", 'tables', 'stage_runtime_closure_notes.md'), 'tables/stage_runtime_closure_notes.md', 'table'; ...
...
recommended_roots = local_build_recommended_roots(strict_root, baseline_root, stage_smoke_root(tag, cfg), delivery_root);
