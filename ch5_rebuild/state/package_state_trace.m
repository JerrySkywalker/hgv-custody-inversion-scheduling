...
state_trace.valid_for_bubble = bubble.valid_for_bubble(:);
state_trace.is_full_window = wininfo.is_full_window(:);
state_trace.window_count = wininfo.window_count(:);
...
state_trace.meta.window_length_steps = ch5case.window.length_steps;
state_trace.meta.window_mode = ch5case.window.mode;
