function hgv_cfg = build_dynamics_init_from_case(case_i, cfg)
    %build_dynamics_init_from_case
    ...
    %   - control profile is delegated to build_control_profile()
        ...
        % ------------------------------------------------------------
        ctrl_profile = build_control_profile(case_i, cfg);
