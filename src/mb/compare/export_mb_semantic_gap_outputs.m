...
for idx = 1:numel(comparison.run_pairs)
    ...
    pass_global_csv = fullfile(paths.tables, sprintf('MB_comparison_passratio_overlay_globalFullReplay_%s_%s.csv', h_label, sensor_group));
    ...
    global_view_spec = semantic_view_spec;
    global_view_spec.domain_view = "global_full_replay";
    global_view_spec.figure_name = sprintf('MB_comparison_passratio_overlay_globalFullReplay_%s_%s.png', h_label, sensor_group);
    ...
    global_view_spec.raw_eval_table = pair.legacy_eval_table;
    [legacy_global_source, ~, legacy_global_meta] = build_mb_passratio_domain_view(pair.legacy_passratio_table, pair.search_domain, global_view_spec);
    global_view_spec.raw_eval_table = pair.closed_eval_table;
    [closed_global_source, ~, closed_global_meta] = build_mb_passratio_domain_view(pair.closed_passratio_table, pair.search_domain, global_view_spec);
    pass_global_table = local_build_comparison_passratio_view_table(legacy_global_source, closed_global_source);
    pass_global_meta = local_build_comparison_view_meta(pair.search_domain, pair.passratio_gap_table, pass_global_table, legacy_global_meta, closed_global_meta);
    ...
    fig_pass_history = plot_semantic_gap_passratio_curves(pass_history_table, pair.h_km, sensor_label, struct( ...
        ...
        'plot_view_contract', resolve_mb_plot_view_contract(local_getfield_or(plot_options, 'runtime', struct()), struct('passratio_mode', "historyFull")), ...
        'scope_annotation_text', "status: history view from real computed points only", ...
        'runtime', local_getfield_or(plot_options, 'runtime', struct()), ...
        'figure_style', local_getfield_or(plot_options, 'figure_style', struct())));
    ...
    fig_pass_effective = plot_semantic_gap_passratio_curves(pass_effective_table, pair.h_km, sensor_label, struct( ...
        ...
        'plot_view_contract', resolve_mb_plot_view_contract(local_getfield_or(plot_options, 'runtime', struct()), struct('passratio_mode', "effectiveFullRange")), ...
        'scope_annotation_text', "status: effective domain only, not global", ...
        'runtime', local_getfield_or(plot_options, 'runtime', struct()), ...
        'figure_style', local_getfield_or(plot_options, 'figure_style', struct())));
    ...
    fig_pass_global = plot_semantic_gap_passratio_curves(pass_global_table, pair.h_km, sensor_label, struct( ...
        'passratio_saturation_table', pair.passratio_saturation_table, ...
        'boundary_hit_table', pair.boundary_hit_table, ...
        'search_domain_bounds', [pair.search_domain.history_ns_min, pair.search_domain.history_ns_max], ...
        'plot_domain_label', "global_full_replay", ...
        'plot_domain_source', "global_full_replay", ...
        'plot_xlim_ns', pass_windows.global_full_replay, ...
        'current_mode', "globalFullReplay", ...
        'plot_view_contract', resolve_mb_plot_view_contract(local_getfield_or(plot_options, 'runtime', struct()), struct('passratio_mode', "globalFullReplay")), ...
        'scope_annotation_text', "status: global replay from defined points only", ...
        'runtime', local_getfield_or(plot_options, 'runtime', struct()), ...
        'figure_style', local_getfield_or(plot_options, 'figure_style', struct())));
    pass_global_png = fullfile(paths.figures, sprintf('MB_comparison_passratio_overlay_globalFullReplay_%s_%s.png', h_label, sensor_group));
    ...
    write_mb_plot_domain_sidecar(pass_global_png, "global_full_replay", "full_search_domain", local_capture_axis_xlim(fig_pass_global), ...
        ...
        'canonical_primary_mode', plot_mode_profile.canonical_primary_mode, ...
        'current_mode', "globalFullReplay", ...
        'is_primary_selection', plot_mode_profile.comparison_primary_mode == "globalFullReplay", ...
    ...
    fig_pass_zoom = plot_semantic_gap_passratio_curves(pass_zoom_table, pair.h_km, sensor_label, struct( ...
        ...
        'plot_view_contract', resolve_mb_plot_view_contract(local_getfield_or(plot_options, 'runtime', struct()), struct('passratio_mode', "frontierZoom")), ...
        'runtime', local_getfield_or(plot_options, 'runtime', struct()), ...
        'figure_style', local_getfield_or(plot_options, 'figure_style', struct())));
    ...
    primary_pass = pass_mode_files.(char(export_plot_plan.primary_comparison_view));
    ...
    summary_context = local_summary_context_table(pair, struct( ...
        ...
        'global_full_replay_rendered_min_ns', local_pick_x(local_capture_axis_xlim(fig_pass_global), 1), ...
    ...
    artifacts.tables.(matlab.lang.makeValidName(sprintf('passratio_overlay_globalFullReplay_%s', h_label))) = string(pass_global_csv);
...
view_meta.source_table_kind = string(local_getfield_or(legacy_meta, 'source_table_kind', local_getfield_or(closed_meta, 'source_table_kind', "")));
view_meta.dense_rebuild_used = logical(local_getfield_or(legacy_meta, 'dense_rebuild_used', false) || local_getfield_or(closed_meta, 'dense_rebuild_used', false));
view_meta.inherited_from_effective_dense = logical(local_getfield_or(legacy_meta, 'inherited_from_effective_dense', false) || local_getfield_or(closed_meta, 'inherited_from_effective_dense', false));
view_meta.zero_padding_used = logical(local_getfield_or(legacy_meta, 'zero_padding_used', false) || local_getfield_or(closed_meta, 'zero_padding_used', false));
view_meta.sparse_projection_used = logical(local_getfield_or(legacy_meta, 'sparse_projection_used', false) || local_getfield_or(closed_meta, 'sparse_projection_used', false));
