...
%
% Current scope:
%   - read latest Stage14.2 envelope result if available
%   - otherwise rebuild envelope_table through stage14_plot_ns_envelopes
...
%   - no B2 / B2-dual yet
    ...
    % Reuse Stage14.2 step2 builder to ensure consistent envelope_table
    env_out = stage14_plot_ns_envelopes(cfg, local);
