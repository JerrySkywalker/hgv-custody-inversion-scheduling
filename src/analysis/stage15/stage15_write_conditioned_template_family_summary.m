function stage15_write_conditioned_template_family_summary(pathStr, template_library)
%STAGE15_WRITE_CONDITIONED_TEMPLATE_FAMILY_SUMMARY

fid = fopen(pathStr, 'w');
assert(fid >= 0, 'Failed to open file: %s', pathStr);
cleanupObj = onCleanup(@() fclose(fid)); %#ok<NASGU>

fprintf(fid, '=== Stage15-E Conditioned Template Family Summary ===\n');
