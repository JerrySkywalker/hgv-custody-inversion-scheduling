function profile = make_profile_MB_heading_small_formal()
task_profile = make_ch4_task_profile();
grid_profile = make_ch4_design_grid_profile();

rows = expand_ch4_design_grid_profile(grid_profile.small_formal, 'H');

profile = struct();
profile.name = 'MB_heading_small_formal';
profile.mode = 'static';
