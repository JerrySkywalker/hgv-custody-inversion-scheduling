...
%   out = stage09_plot_inverse_design_results(out9_4, out9_5, cfg);
    ...
    fig_diag = plot_stage09_stage05_aligned_diagnostics(out9_4, cfg, timestamp);
    ...
    figure_index_table = table( ...
        string(fig_diag.fig_diag_scatter), ...
        string(fig_diag.fig_diag_frontier), ...
        string(fig_diag.fig_diag_heatmap_minNs_iP), ...
        string(fig_diag.fig_diag_heatmap_bestDG_iP), ...
        string(fig_diag.fig_diag_passratio_profile), ...
        ...
        'VariableNames', { ...
            'fig_diag_scatter', ...
            'fig_diag_frontier', ...
            'fig_diag_heatmap_minNs_iP', ...
            'fig_diag_heatmap_bestDG_iP', ...
            'fig_diag_passratio_profile', ...
            'fig_minNs_hi', ...
            'fig_fail_hi_refPT', ...
            'fig_feasible_PT', ...
            'fig_Ns_vs_margin', ...
    ...
    out.files.fig_diag_scatter = fig_diag.fig_diag_scatter;
    out.files.fig_diag_frontier = fig_diag.fig_diag_frontier;
    out.files.fig_diag_heatmap_minNs_iP = fig_diag.fig_diag_heatmap_minNs_iP;
    out.files.fig_diag_heatmap_bestDG_iP = fig_diag.fig_diag_heatmap_bestDG_iP;
    out.files.fig_diag_passratio_profile = fig_diag.fig_diag_passratio_profile;
    ...
    log_msg(log_fid, 'INFO', 'Exported %d primary figure paths.', width(figure_index_table));
