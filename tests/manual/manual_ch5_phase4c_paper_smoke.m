...
out = run_ch5r_phase4c_paper_pipeline(struct( ...
    'max_cases', 4, ...
...
assert(out.ok);
assert(numel(out.case_ids) == 4);
assert(height(out.phase4ab.phase4a.stats.overall) >= 4);

disp('=== manual_ch5_phase4c_paper_smoke passed ===')
disp(out.case_ids)
