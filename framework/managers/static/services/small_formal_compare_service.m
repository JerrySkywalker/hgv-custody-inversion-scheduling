...
compare_tbl = innerjoin( ...
    tbl_nom(:, {'design_id','P','T','h_km','i_deg','Ns','pass_ratio','is_feasible','joint_margin'}), ...
    tbl_head(:, {'design_id','P','T','h_km','i_deg','Ns','pass_ratio','is_feasible','joint_margin'}), ...
    'Keys', {'P','T','h_km','i_deg','Ns'}, ...
    'LeftVariables', {'design_id','P','T','h_km','i_deg','Ns','pass_ratio','is_feasible','joint_margin'}, ...
    'RightVariables', {'design_id','pass_ratio','is_feasible','joint_margin'} ...
);

compare_tbl = renamevars(compare_tbl, ...
    {'design_id_tbl_nom','pass_ratio_tbl_nom','is_feasible_tbl_nom','joint_margin_tbl_nom', ...
     'design_id_tbl_head','pass_ratio_tbl_head','is_feasible_tbl_head','joint_margin_tbl_head'}, ...
