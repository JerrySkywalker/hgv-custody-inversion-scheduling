...
assert(height(r_nom.truth_result.table) == 16, 'Expected 16 nominal small-formal truth rows.');
assert(height(r_head.truth_result.table) == 16, 'Expected 16 heading small-formal truth rows.');
