...
pool.summary = struct( ...
    ...
    'timing', struct( ...
        ...
        'derive_family_total_s', t_nominal_s + t_heading_s + t_critical_s, ...
        'total_pipeline_s', t_hi_s + t_pt_s + t_local_s + t_merge_s + t_joint_s + t_nominal_s + t_heading_s + t_critical_s), ...
