function assert_stage05_closedd_manual_raan_wrapper()
startup;

out = manual_smoke_stage05_closedd_manual_raan_wrapper();

assert(isequal(out.grid_size, [9 35]), 'Expected grid_table size [9 35].');
...
disp('assert_stage05_closedd_manual_raan_wrapper passed.');
end
