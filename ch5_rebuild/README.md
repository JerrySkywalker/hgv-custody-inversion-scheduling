...
## 当前状态（R2-real / R3-real / R4-real / R4c-real / R5 / R5c-real / R6-real / R7-real / R8-real / R8.1 / R8.2 / R8.3a / R8.4 / R8.5b / R8.6 主线）
...
- R8.5b：outerB 评分重标定版
- R8.6：真实 RMSE 与完整 compare bundle
...
out = run_ch5r_phase8_6_closed_loop_compare_bundle();
